require 'rails_helper'
 ...
 RSpec.describe Api::V1::Topics::PostsController, type: :controller do
   ...
   context "unauthenticated user" do
     ...
     it "PUT update returns http unauthenticated" do
       put :update, topic_id: my_topic.id, id: my_post.id, post: {name: "Post Name", description: "Post Description"}
